...
export class HalResourceService<T extends BaseResource> {
  ...
  constructor(type: new() => T,
    ...
    this.resourceHttpService = DependencyInjector.get(ResourceHttpService);
  ...
  public get(id: any, params?: HalParam): Observable<BaseResource> {
    return this.resourceHttpService.get(this.type, this.resource, id, params);
  }
}
