...
describe('AbstractResource', () => {
    ...
    it('should return false if relation link is not present', () => {
        expect(linkAbstractResource.hasRelation('products')).toBe(false);
    });

    it('should return true if relation link is present', () => {
        expect(linkAbstractResource.hasRelation('self')).toBe(true);
    });

    it('should return false if relation links are empty', () => {
        expect(emptyLinkAbstractResource.hasRelation('self')).toBe(false);
        expect(emptyLinkAbstractResource.hasRelation('products')).toBe(false);
    });
