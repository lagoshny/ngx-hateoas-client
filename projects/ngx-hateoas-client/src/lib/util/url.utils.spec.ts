...
describe('UrlUtils', () => {
    ...
    it('GENERATE_LINK_URL should fill ALL template params when link is templated', () => {
        const result = UrlUtils.generateLinkUrl({ href: `${UrlUtils.getApiUrl(DEFAULT_ROUTE_NAME)}/test{?param1,param2}`, templated: true }, {
            params: {
                param1: '1',
                param2: '2'
            }
    ...
    it('GENERATE_LINK_URL should fill PART OF template params when link is templated and passed not all params', () => {
        const result = UrlUtils.generateLinkUrl({ href: `${UrlUtils.getApiUrl(DEFAULT_ROUTE_NAME)}/test{?param1,param2,sort,page,size}`, templated: true }, {
            params: {
                param1: '1'
            },
            pageParams: {
    ...
    it('GENERATE_LINK_URL should NOT FILL template params when link is not templated', () => {
        const result = UrlUtils.generateLinkUrl({ href: `${UrlUtils.getApiUrl(DEFAULT_ROUTE_NAME)}/test{?param1,param2}`, templated: false });
